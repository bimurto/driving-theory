...
export function SiteShell({ children }: { children: ReactNode }) {
  ...
  const links = [{ href: "/", label: "Home" }, { href: "/practice", label: "Practice" }, { href: "/starred", label: "Starred" }, { href: "/topics", label: "Topics" }, { href: "/progress", label: "Progress" }, { href: "/account", label: "Account" }];
