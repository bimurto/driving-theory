...
source_sha256: ae02d09834c5df570be34967f594076bf87ca8eb49cdac16e51eb9fd92c4b2ad
...
that release or order it cleared. [StVO §2(1)](https://www.gesetze-im-internet.de/stvo_2013/__2.html) [StVO Annex 2,
signs 223.1–223.3](https://www.gesetze-im-internet.de/stvo_2013/anlage_2.html)
...
requires—and correct the route later. **Zeichen 295 Fahrstreifenbegrenzung** may
not be crossed even partly; direction arrows between lane lines must also be
followed at the junction. [StVO Annex 2, signs 295 and 297](https://www.gesetze-im-internet.de/stvo_2013/anlage_2.html)
...
the oncoming vehicle to pass rather than forcing a stand-off. Constant caution
and mutual consideration govern the solution. [StVO §1](https://www.gesetze-im-internet.de/stvo_2013/__1.html)
...
outside-built-up-area overtaking situations in StVO §16—not to hurry animals.
...
the right has priority. [StVO Annex 1, sign 102](https://www.gesetze-im-internet.de/stvo_2013/anlage_1.html) [StVO §8(1)](https://www.gesetze-im-internet.de/stvo_2013/__8.html)

Before crossing a priority road, assess its width, the speed and distance of
cross traffic, visibility, grip, and weather. Those factors determine both the
available gap and how long your vehicle needs to clear the conflict area. Yield
with a moderate-speed approach and proceed only when the whole crossing can be
completed safely. [StVO §8(2)](https://www.gesetze-im-internet.de/stvo_2013/__8.html)
...
vehicle design eligibility, not a requirement to drive above 60 km/h.
[StVO §18(1)](https://www.gesetze-im-internet.de/stvo_2013/__18.html)
...
miss the moped. Permission to use the path does not create visibility or
priority by itself. Adjust speed, keep door clearance, and anticipate turning
conflicts under the general caution rule. [StVO §1](https://www.gesetze-im-internet.de/stvo_2013/__1.html)

## Common exam traps

- Calling the shoulder an ordinary traffic lane.
- Using a shoulder to overtake because it looks wide enough.
- Crossing a continuous line to fix a wrong turn.
- Assuming the larger road has priority despite sign 102 or right-before-left.
- Looking only at cross-traffic distance and ignoring road width or wet weather.
- Reading “more than 60 km/h” as “at least 60 km/h.”
- Assuming a moped on a cycle path will be seen by turning drivers.

## Remember this

- **Shoulder:** not part of the carriageway; no general overtaking use.
- **Slow rural vehicles:** use a suitable paved shoulder where the marking rule applies.
- **Wrong lane + solid line:** continue legally and reroute.
